...
namespace NetDataAccess.Extended.Id.List
{
    ...
    {
        private string _ShopSearchPageUrlFormat = "https://idempiere.atlassian.net/issues/?filter=-4&startIndex={pageIndex}";
        ...
        private bool GenerateUrlListFile()
        {
            ...
            Dictionary<string, int> columnDic = CommonUtil.InitStringIndexDic(new string[]{
                    ...
                    "grabStatus", 
                    "giveUpGrab" });
            string slPath = Path.Combine(exportDir, "Id列表页.xlsx");
