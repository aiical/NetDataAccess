...
namespace NetDataAccess.Base.CsvHelper
{
    ...
    /// </summary>
    public sealed class ElencyCsvReader : IDisposable
    {
        ...
        public ElencyCsvReader(string filePath)
        {
            _type = Type.File;
        ...
        public ElencyCsvReader(string filePath, Encoding encoding)
        {
            _type = Type.File;
        ...
        public ElencyCsvReader(Stream stream)
        {
            _type = Type.Stream;
        ...
        /// <param name="stream">Stream</param>
        /// <param name="encoding">Encoding</param>
        public ElencyCsvReader(Stream stream, Encoding encoding)
        {
            _type = Type.Stream;
        ...
        public ElencyCsvReader(Encoding encoding, string csvContent)
        {
            _type = Type.String;
