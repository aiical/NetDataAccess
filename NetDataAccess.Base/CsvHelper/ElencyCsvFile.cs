...
namespace NetDataAccess.Base.CsvHelper
{
    ...
    /// </summary>
    [Serializable]
    public sealed class ElencyCsvFile
    {
        ...
        {
            using (ElencyCsvReader reader = new ElencyCsvReader(filePath, encoding) { HasHeaderRow = hasHeaderRow, TrimColumns = trimColumns })
            {
        ...
        {
            using (ElencyCsvReader reader = new ElencyCsvReader(stream, encoding) { HasHeaderRow = hasHeaderRow, TrimColumns = trimColumns })
            {
                PopulateCsvFile(reader);
            }
        }
        ...
        {
            using (ElencyCsvReader reader = new ElencyCsvReader(encoding, csvContent) { HasHeaderRow = hasHeaderRow, TrimColumns = trimColumns })
            {
                PopulateCsvFile(reader);
            }
        }
