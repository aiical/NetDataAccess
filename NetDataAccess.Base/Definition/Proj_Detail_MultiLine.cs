...
namespace NetDataAccess.Base.Definition
{
    ...
    /// 列表页设置
    /// </summary>
    public class Proj_Detail_MultiLine : IProj_FieldConfig
    {
        #region MultiCtrlPath
        private string _MultiCtrlPath;
        /// <summary>
        /// MultiCtrlPath
        /// </summary>
        public string MultiCtrlPath
        {
            set
            {
                _MultiCtrlPath = value;
            }
            get
            {
                return _MultiCtrlPath;
            }
        }
        #endregion
        ...
        private int _IntervalProxyRequest;
        /// <summary>
        /// 同一个代理，两次访问的间隔时间
        /// </summary>
        ...
        private int _IntervalAfterLoaded;
        /// <summary>
        /// IntervalAfterLoaded
        /// </summary>
        public int IntervalAfterLoaded
        {
            set
            {
