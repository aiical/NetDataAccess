...
{
    public class SMDetailPageUrl : CustomProgramBase
    {
        ...
        private bool GetAllDetailPageUrl(IListSheet listSheet)
        {
            ...
            for (int i = 0; i < listSheet.RowCount; i++)
            {
                ...
                { 
                    ...
                    {
                        {
                            HtmlAgilityPack.HtmlDocument htmlDoc = this.RunPage.GetLocalHtmlDocument(listSheet, i, Encoding.GetEncoding("GBK"));
                            HtmlNodeCollection itemNodes = htmlDoc.DocumentNode.SelectNodes("//ul[@class=\"prolist cls\"]")[0].SelectNodes("./li");
                            if (itemNodes != null)
                            {
                                foreach (HtmlNode itemNode in itemNodes)
                                {
                                    ...
                                    HtmlNode nameNode = itemNode.SelectSingleNode("./div[1]/p[@class=\"title\"]/a");
                                    ...
                                    if (length > 0)
                                    {
                                        ...
                                        p2vs.Add("detailPageName", detailPageName + "_" + category1Code + "_" + category2Code + "_" + category3Code);
