...
{
    public class FeiniuListPageUrl : CustomProgramBase
    {
            ...
            for (int i = 0; i < listSheet.RowCount; i++)
            {
                ...
                if (!giveUp)
                {
                    ...
                    try
                    {
                        ...
                        HtmlNode pageCountNode = htmlDoc.DocumentNode.SelectSingleNode("//span[@class=\"page_count fontT\"]");
                        string pageCountStr = pageCountNode == null ? "1" : pageCountNode.InnerText.Trim();
                        ...
                        for (int j = 0; j < pageCount; j++)
                        {
                            ...
                            string detailPageUrl = url + "?page=" + (j + 1);
