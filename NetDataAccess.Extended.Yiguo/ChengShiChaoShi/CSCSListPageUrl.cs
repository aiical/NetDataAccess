...
{
    public class CSCSListPageUrl : CustomProgramBase
    {
            ...
            for (int i = 0; i < listSheet.RowCount; i++)
            {
                ...
                if (!giveUp)
                {
                    ...
                    try
                    {
                        ...
                        HtmlNode pageNode = htmlDoc.DocumentNode.SelectSingleNode("//span[@class=\"num\"]");
                        ...
                        for (int j = 0; j < pageCount; j++)
                        {
                            ...
                            string detailPageUrl = url + "?PageIndex=" + (j + 1) + "&PageSize=20";
