...
{
    public class GetBenkeXuekeListPage_jhcee_com : ExternalRunWebPage
    {
        ...
        private void GetList(IListSheet listSheet)
        {
            ...
            resultColumnDic.Add("id", 6);
            resultColumnDic.Add("parentId", 7); 
            string resultFilePath = Path.Combine(exportDir, "教育_本科_门类_jhcee_com.xlsx");
