...
{
    public class KeywordsSearchRequest : ExternalRunWebPage
    {
        ...
        private ExcelWriter GetExcelWriter()
        {
            ...
            Dictionary<string, int> resultColumnDic = CommonUtil.InitStringIndexDic(new string[]{
                ...
                "keywords",
                "pageIndex"});
            string resultFilePath = Path.Combine(exportDir, "Linkedin关键字个人详情页.xlsx");
        ...
        private ExcelWriter GetNoneMatchedExcelWriter()
        {
            ...
            Dictionary<string, int> resultColumnDic = CommonUtil.InitStringIndexDic(new string[]{
                "keywords",
                "MatchType"});
            string resultFilePath = Path.Combine(exportDir, "Linkedin关键字自动匹配结果.xlsx");
