...
{
    /// <summary>
    /// 获取各省下属县区构成的js boundary信息
    /// </summary>
    public class MapDistrictAndProvinceNext2Level : ExternalRunWebPage
    { 
        ...
        public override void GetDataByOtherAcessType(Dictionary<string, string> listRow)
        {
            ...
            {
                List<string> childCodes = this.GetNext2LevelDistrictCodes(trimCode);
                ...
                int pointZipSize = 30;
                string pointZipStringFormat = "#0.0";
                ...
                StringBuilder ss = new StringBuilder("boundaryList[\"" + code + "_L2\"] = ");
                ...
                string localFilePath = this.RunPage.GetFilePath(detailPageUrl + "_L2.js", pageSourceDir);
        ...
        private List<string> GetNext2LevelDistrictCodes(string trimCode)
        {
